            ...
            <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
               <ul className="space-y-2 font-medium">
                  <li>
                     ...
                     <article>
                        <div className="flex items-center mb-4 bg-gray-700 rounded-xl px-2 py-1">
                           <img className="w-10 h-10 me-4 rounded-full" src="https://tailwindcomponents.com/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg" alt="" />
                           <div className="font-medium dark:text-white">
                              <p> <Link href="/user">Jese Leos</Link>
                                 <div className="block text-sm text-gray-500 dark:text-gray-400">Joined on August 2014</div>
                              </p>
         ...
         <div className="p-4 sm:ml-64 h-full">
            <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
               <div className="flex items-center justify-center h-48 mb-4 rounded bg-gray-50 dark:bg-gray-800">
                  ...
                  <h1 className=" text-gray-500">enviroment slide</h1>
